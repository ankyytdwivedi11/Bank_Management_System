 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">  <a class="nav-link" href="maddnew.php">New Account</a></li>
...
<div class="card w-100 text-center shadowBlue">
  <div class="card-header">
    Staff Account Details <button class="btn btn-outline-info btn-sm float-right" data-toggle="modal" data-target="#exampleModal">New</button>
  </div>
  <div class="card-body">
